<script>
  ...
  const filmes = [
    ...
    { id: 10, titulo: 'Mortal Kombat', genero: 'Ação', ano: 2019, nota: 9.8, emoji: '&', sinopse: 'Lutando pela sobrevivencia' },
    { id: 11, titulo: 'Predador', genero: 'Ficção Científica', ano: 2020, nota: 8.0, emoji: '¨$', sinopse: 'È o bicho' },
